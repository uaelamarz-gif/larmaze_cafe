     ...
     return (
          <div className="social flex justify-end gap-4">
               ...
               <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="rounded-md p-2 bg-linear-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 transition-colors flex items-center justify-center text-xl text-white"
               >
                    <FaInstagram />
               </a>
               <a
